        ...
        <div className="border-t border-white/20 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6 text-xs sm:text-sm menu-en">
              <a href="#privacy" className="text-white/60 hover:text-[#FCB283] transition-colors">Privacy Policy</a>
              <a href="#terms" className="text-white/60 hover:text-[#FCB283] transition-colors">Terms of Service</a>
              <a href="#cookies" className="text-white/60 hover:text-[#FCB283] transition-colors">Cookie Policy</a>
            </div>
          </div>
