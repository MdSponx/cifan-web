...
import FileReplacer from '../applications/FileReplacer';
        ...
        <FormSection title={currentContent.filesTitle} icon="📁">
            <div className="space-y-6">
              <FileReplacer
                ...
                onFileReplaced={(newFileMetadata) => handleFileReplaced('filmFile', newFileMetadata)}
              ...
              <FileReplacer
                ...
                onFileReplaced={(newFileMetadata) => handleFileReplaced('posterFile', newFileMetadata)}
                onError={(error) => setError(error)}
              />
              ...
              {application.files.proofFile && (
                <FileReplacer
                  ...
                  onFileReplaced={(newFileMetadata) => handleFileReplaced('proofFile', newFileMetadata)}
                  onError={(error) => setError(error)}
                />
              )}
            </div>
